...
│   ├── clash/             # Clash core integration
│   ├── ui/                # User interface components
│   ├── i18n/              # Internationalization (auto-generated)
│   └── src/bindings/      # Rust-Flutter bridge (auto-generated)
├── native/                # Rust code
│   ├── hub/              # Main Rust logic (with signal definitions)
│   └── stelliberty_service/  # Desktop service executable
├── scripts/              # Build and prebuild scripts
│   ├── prebuild.dart     # Pre-build preparation
│   └── build.dart        # Build and packaging
└── assets/               # Runtime assets (generated by prebuild)
```
